...
<html lang="en">
  ...
  <body>
    <!-- header  -->
        ...
        <h5 class="text-center" style="color:#2170AC;">Ashram School Students</h5>
                    ...
                    <p id="result" class="text-center"></p>
                          ...
                          <div class="row form-container">
                              <div class=" col-md-12 text-center  form-check form-container">
                                  <p class="mt-0 ms-0" style="color:#2170AC;">Already have an account ? <a href="signin" >Login</a></p>
                     ...
                     // AJAX Code To Submit Form.
                      ...
                      success: function(data){
                            ...
                            if(data == 1){
                             ...
                             setTimeout(() => {
                                $("#result").html("Email ID already exits").css({"background-color": "none","font-size": "16px","color":"red","Padding":"0px 45px"});
                                          },1000);
                                          $("#regForm").trigger("reset");  
                             }
