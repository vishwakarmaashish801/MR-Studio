...
$user_id = $_SESSION['user_id'];
  ...
  $sql1 = "SELECT * FROM result_ashram where student_id='$user_id'";
                            ...
                            if($key == "Time Management") {
                                ...
                                if($value >= 7 && $value <= 10) {
                                    ...
                                    $percent = intval(($t*10))."%"; 
                                        ...
                                        parent.document.getElementById("information_time").innerHTML="<div style=\"text-align:center; font-weight:bold\"> Time</div>";
                                    ...
                                    $total= $value;
                                    $content_time = "<div class='col-md-11 ' style=' text-align: justify;margin-left: auto;margin-right: auto;'>Your responses are very poor in Time Management domain which highlights that you face challenges in managing things and your work. This is a serious level for your personal and professional life. Looking at the answers given by you, it seems that you face many challenges in preparing the schedule for studies/exams/work, due to which you are unable to follow your work plan successfully. You are unable to keep track of your tasks. You are neither strict for yourself nor for the work, and do not follow strictly. You study in an unorganized way due to which your exam results do not suit you. You don't study for the whole academic year. Preferably study just before the exam and get stressed. You are always busy with other activities. You get enough time for them. But, nothing to worry about. You can enhance your Time Management stage in the following way: ● Figure out how you’re currently spending your time: To optimize your personal time management, you first need to figure out where the time is going. Try diligently logging your time for a week by tracking your daily activities.● Create a daily schedule—and stick with it: Putting everything on paper will prevent you from lying awake at night tossing and turning over the tasks running through your brain. Instead, your subconscious goes to work on your plans while you are asleep, which means you can wake up in the morning with new insights for the workday. If youcan’t do it the day before, make sure you write out your list first thing in the morning. You’ll find that the time you spend creating a clear plan is nothing compared to the time you’ll lose jumping between tasks when you lack such a plan ● Prioritize wisely: Prioritization is key for successful time management at work. Start by eliminating tasks that you shouldn’t be performing in the first place. Then identify the three or four most important tasks and do those first—that way, you make sure you finish the essentials. ● Group similar tasks together: Save yourself time and mental energy by trying to complete all of one type of to-do before moving on to the next. ● Avoid the urge to multitask: This is one of the simplest time management tips for work, yet it can be one of the hardest to follow. Focus on the task at hand and block out all distractions.● Assign time limits to tasks: Part of creating your schedule should involve setting timelimits on tasks instead of just working until they’re done. To-do lists are great and wonderful, but sometimes you might feel like you never check anything off. ● Build in buffers: It may sound counterintuitive, but breaks are essential to better time management. Make breaks a part of your schedule. When you finish a task, give yourself time to breathe. Take mini breaks to recharge, whether that be a short walk, a game of ping pong, some meditation, etc. ● Learn to say no: You’ll never learn how to manage time at work if you don’t learn how to say no. Only you truly know what you have time for, so if you need to decline a request in order to focus on more important tasks, don’t hesitate to do so. And if you take on a project that is obviously going nowhere, don’t be afraid to let it go. ● Get organized: For effective time management, this tip needs to go on your to-do list. If you have piles of papers scattered all over your desk, finding the one you need will be like finding a needle in a haystack. There are few things as frustrating as wasting valuable time looking for misplaced items. ● Eliminate distractions: Social media, web browsing, co-workers, text messages, instant messaging—the distractions at work can be limitless. A key to personal time management is being proactive about getting rid of them. Shut your door to limit interruptions.</div>";
                            ...
                            if($key == "Coping Management") {
                                ...
                                if($value >= 8 && $value <= 11) {
                                    ...
                                    for($c;$c<=$total;$c++)
                                    {
                                        ...
                                        parent.document.getElementById("content_cop").innerHTML="<div style=\"text-align:center; font-weight:bold\">'.$content_cop.'</div>";
                                        </script>';
