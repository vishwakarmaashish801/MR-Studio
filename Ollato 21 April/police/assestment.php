    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
           ...
           <?php include 'side-navbar.php'; ?>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="assestment">
                    <i class="fas fa-fw fa-chart-area"></i>
            ...
            <!--    <p class="text-center mb-2"><strong>Serac Education</strong> is packed with premium features,-->
            ...
            <!-- logout section -->
          <div class="sidebar-card d-none d-lg-flex">
           <a class="btn btn-danger btn_logout btn-sm" href="#" data-toggle="modal" data-target="#logoutModal">  <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i> Logout</a>
            </div>
        </ul>
        <!-- End of Sidebar -->
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between py-3">
                                    <div class="div">
                                        <h6 class="m-0 font-weight-bold text-primary">Police Professional Assestment Test</h6>
                                    </div>
                                    <!--Timer-->
            ...
            $(document).ready(function () {
                ...
                $(document).on('click', '.pagination_link_submit', function (e) {
                    ...
                    if (tempLength == totalques) {
                        ...
                        $.redirect("action/backend_f2",dataArray,"POST");
