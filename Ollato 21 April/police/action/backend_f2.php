                                    ...
                                    <h3 class=" my-2 fw-bold text-center"> Police Professional Assestment</h3>
                                      ...
                                      <p class=" my-2 fw-bold text-center">login Again</p>
                                       <div class="container align-middle">
                                        <p class="fw-bold text-center"><span class="align-middle">Click Here </span>&nbsp; <a href="dashboard"  class="btn border align-middle btn-outline-primary"> Home</a></p>
                                        </div>
                                       </div>
    ...
    //   Add New Daomin Fro array to database
        ...
        if (mysqli_num_rows($check_studentid) > 0 ) {
            ...
            <?php
             ...
             $insert = "INSERT IGNORE INTO result (sr_no,user_id,user_name,Anxiety,Depression,Stress,PTSD,Burnout,Job_Security,Work_Environment,Work_Load,Job_Satisfaction,Work_Life_Balance,Career_Opportunities,Coping_Mechanism,Family_Support,Female_Domain,exam_date,status
                                         ) VALUES ('','$user_id','$st_name','$anx','$dep','$ss','$pstd','$burn','$jobs','$we','$wl','$js','$wlb','$co','$cm','$fs','$fp',now(),'$status)'";
