  ...
  <body>
    ...
    <div class="container form-container" style="margin-top:0px;margin-bottom: 40px;" >
      ...
      <div class="form-title">
        <h5 class="text-center" style="color:#2170AC;">Administrator Panel</h5>
        ...
        <form  id="loginForm"  method="POST" onsubmit="Validate();return false"> 
          <div class=" col-md-4 mb-3 mx-auto">
            ...
            <input type="text" class="form-control" id="InputEmail1" aria-describedby="em  ailHelp" name="email" autocomplete="off">
          ...
          <div class="col-md-4 mb-3 mx-auto">
            ...
            <i class="fa fa-eye pass-icon" onclick="pass()" style="float: right;margin:-29px 8px;"></i>
            </div>
          ...
          <button type="submit" class="btn" style="background-color:#2170AC;color:#fff">Login</button>
           <p class="mt-2" style="color:#2170AC;"> <a href = "#" style="text-decoration: none;"> Forgot password  </a> </p> 
