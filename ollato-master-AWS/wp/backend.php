       ...
       if (isset($_SESSION['$domainarray'])) {
        ...
        if (mysqli_num_rows($check_studentid) > 0) {
                                  ...
                                  <h3 class=" my-1 fw-bold text-center text-light">Welcome To Serac Education  </h3>
                                   ...
                                   <div class="container my-5">
                                     ...
                                     <div class="my-2 container d-flex justify-content-center gap-5">
                                        <h4 class=" "><span class="text-primary">User ID : </span> <?php echo $user_id ?> </h4>
                                        <h4 class=" "><span class="text-primary">User Name : </span>  <?php  echo $st_name ?> </h4>
                                      </div>
            ...
            <?php
             ...
             // Insertion                                                                                                                                           
             $insert = "INSERT IGNORE INTO result (sr_no,student_id,st_name,Adjustment,Attention,Self_l,Study,Depression,Anxiety,Stress,Time_Management,Sleep,Work_Performance,Coping_Management) VALUES ('','$user_id','$st_name','$adj','$att','$self','$study','$dep','$anx','$stress','$time','$sleep','$work','$cropping')";
            ...
            //  echo"Error Server Timeout ";
             ?>
                         ...
                         <div class=" container mx-auto row footer" style="margin-top:120px;">
                                <div class="container bg-primary p-3"><h3 class=" my-1 fw-bold text-center text-light">Welcome To Serac Education</h3></div>
                                   <div class="container my-5">
                                    <h3 class=" my-2 fw-bold text-center">' Work Professional Assestment '</h3>
                                     ...
                                     <div class="my-2 container d-flex justify-content-center gap-5">
                                      ...
                                      <p class=" my-2 fw-bold text-center">Error Insertion?? Server Timeout Out</p>
            ...
            <?php
                ...
                //  echo"<br>";
                //  echo "User ID And Student ID  Not Matched  ....Inserted Data To Mysql"; 
                ?>
                      <div class=" container mx-auto row footer" style="margin-top:120px;">
                              <div class="container bg-primary p-3">
                                <h3 class=" my-1 fw-bold text-center text-light">Welcome To Serac Education  </h3>
