...
if($payment_status == 'Active'){
            ...
            $query = "SELECT * FROM questions_interest ORDER BY sr_no ASC LIMIT $start_from, $record_per_page";  
            ...
            //  end table body
             ...
             $page_query = "SELECT * FROM questions_interest ORDER BY sr_no ASC";  
             ...
             echo $output;  
              ...
              $payment_fail  .='<div class="col-md-6 mx-auto">
                                ...
                                <div class="card-body">
                                 ...
                                 <a href="/interest/package.php" class="btn btn-primary">Back to Package OR Payment Mode</a> 
                                 </div></div>';
               echo $payment_fail;
           }
