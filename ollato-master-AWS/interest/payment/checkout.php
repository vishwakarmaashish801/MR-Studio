...
<form action="<?php echo $action; ?>"  name="payuform" id="payuform" method="post">
  ...
  <input type="hidden" name="surl" value="https://onemind.ollato.com/interest/payment/success.php" />   
  <!--Please change this parameter value with your success page absolute url like http://mywebsite.com/response.php. -->
  <input type="hidden" name="furl" value="https://onemind.ollato.com/interest/payment/failure.php" />
