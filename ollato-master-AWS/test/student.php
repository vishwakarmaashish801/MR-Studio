...
<head>
    ...
    <title><?php echo   $_SESSION['user']." ".$_SESSION['last']?> - Student Report</title>
   <!-- jquery cdn link -->
    <script
...
.btn-pdf,.btn-home {background: #56cce1; color: #11486d; width: 150px;
    ...
    .graph_box_mob {margin-left: -13px;margin-right: 13px;margin-top: 0;margin-bottom: 0;}

@media (max-width: 425px){

.btn-pdf {margin-right:100%;}
.btn-home{margin-right:341px;}
.img-domain {width:264px;}
 .graph_box_mob{display:none;}
...
<body>
        ...
        <div class="border border-2 container w-75 mt-5">
            <table class="table table-borderless mt-3 mb-3">
               <tr><th>UID No:</th><td><?php echo $_SESSION['user_id'];?></td></tr>
          ...
          <h4 class="mx-2 mt-1 text-start fw-bold print_att">Dear sir/madam,</h4>
          ...
          <p  style="text-align:justify;">Congratulations on choosing Ollato as your partner in your journey towards
            ...
            <img src="img\student-domain-img.png" class="mt-2 img-domain">
           <p style="text-align:justify;margin-top:25px">The domains listed above play a crucial role in determining the mental health status
            ...
            support to navigate these domains effectively and maintain optimal mental wellbeing.</p><br>
           <p class="fw-bold"style="text-align:right;margin-right: 45px;"> Best Regards,<br>
            Team Ollato.
            </p>
            <p class="lh-3" style="margin-top:25px;text-align:justify;"><span class="fw-bold ">Note -</span>“Mental Wellbeing encompasses a wide range of factors, including emotional,
          ...
          <!--end second page-->
           ...
           <div class="page container">
            ...
            <div class="mt-5 d-flex justify-content-around">
                ...
                <div class="container graph-box graph_box_mob d-none">
