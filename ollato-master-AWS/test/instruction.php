                        ...
                        <div class="col-lg-12">
                             <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between py-3">   
                                    <!-- instuction content -->
                                    <div class="container container-instruction">
      <div class="box-container">
        <div class="headers">
          <p class="headers-title">
          ...
          <div class="instruction mb-4">
            <ul type="square" class="square">
              <li class="small font-weight-bold">
               In this test, you will be given statements that are related to your day-to-day life experiences.
              </li>
              <li class="small font-weight-bold">
                Your task is to read the information provided in each statement and mark “Yes” if you agree with the statement and mark “No” if you disagree.
              </li>
              <li class="small font-weight-bold">
               There is no right or wrong response, so please answer without hesitation.
              </li>
              <li class="small font-weight-bold">
                Kindly note, the information provided by you is solely used for academic purposes and all the answers remain confidential.
              </li>
