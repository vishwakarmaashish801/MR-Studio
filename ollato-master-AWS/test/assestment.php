...
<head>
    ...
    <style>
        ...
        .table .td-data:hover { background-color: whitesmoke;color: blue;}
        
        .btn { margin-left: 20px }

        .table, .td-data { color: black; }

         .sr-col { width: 72px; }

        .option-col { width: 80px; }

        .option-hidden { width: 0px; }
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                    <?php echo $_SESSION['user'] . " " . $_SESSION['last'] ?>
                                </span>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between py-3">
                                    <div class="div">
                                        <h6 class="m-0 font-weight-bold text-primary">Student Assestment Test</h6>
                                    </div>
                                    <!--Timer-->
                                ...
                                <div class="card-body p-0">
                                    <div class="form">
                                        ...
                                        <form id="quesForm" action="#" method="POST">
                                            <div id="pagination_data" style="margin-top:-23px">
                                            </div>
            ...
            $(document).ready(function () {
                ...
                $(document).on('click', '.pagination_link_submit', function (e) {
                    ...
                    if (tempLength == totalques) {
                        ...
                        $.redirect("backend_v2.php", dataArray, "POST");
