...
<style>
    ...
    <body>
        ...
        <?php
            ...
            $query = "SELECT * FROM questions_women";
                                    ...
                                    <h3 class=" my-2 fw-bold text-center"> Police Professional Assestment</h3>
                                      ...
                                      <p class=" my-2 fw-bold text-center">login Again</p>
                                       <div class="container align-middle">
                                        ...
                                        <p class="fw-bold text-center"><span class="align-middle">Click Here </span>&nbsp; <a href="dashboard.php"  class="btn border align-middle btn-outline-primary">Dashboard</a>&nbsp;&nbsp; <a href="report.php" class="btn border align-middle btn-outline-primary">View Result</a></p>
    ...
    //   Add New Daomin Fro array to database
        ...
        if (mysqli_num_rows($check_studentid) > 0 ) {
             ...
             $update = "UPDATE result SET user_name = '$st_name', Anxiety = '$anx', Depression = '$dep', Stress = '$ss', PTSD = '$pstd', Burnout = '$burn', Job_Security = '$jobs', Work_Environment = '$we', Work_Load = '$wl', Job_Satisfaction = '$js', Work_Life_Balance = '$wlb',Career_Opportunities = '$co', Coping_Mechanism = '$cm',Family_Support = '$fs',Female_Domain = '$fp' WHERE user_id = $user_id; ";
                                  ...
                                  <h3 class=" my-1 fw-bold text-center text-light">Welcome To Serac Education  </h3>
                                   ...
                                   <div class="container my-5">
                                     ...
                                     <div class="my-2 container d-flex justify-content-center gap-5">
                                      ...
                                      <p class=" my-2 fw-bold text-center">Already Gave the Test </p>
