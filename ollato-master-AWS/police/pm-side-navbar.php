  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="pm_dashboard.php">
          ...
          />
            ...
            <li class="nav-item active">
                <a class="nav-link" href="pm_dashboard.php">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="pm_instruction.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Instruction</span></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="pm_package.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Package/Payment</span></a>
            </li>

            <li class="nav-item active">
                <a class="nav-link" href="pm_assestment.php">
                    <i class="fas fa-fw fa-chart-area"></i>
            ...
            <!-- Nav Item - Charts -->
             <li class="nav-item active">
                <a class="nav-link" href="pm_report.php">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Result</span></a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="pm_book-session.php">
                    <i class="fas fa-fw fa-chart-area"></i>
