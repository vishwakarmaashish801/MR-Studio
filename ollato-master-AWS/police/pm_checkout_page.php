                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                                ...
                                <div class="mb-1">
                                  ...
                                  <div class="mb-1">
                                    <label for="firstName">Full Name :</label>
                                      <label class="text-primary text-capitalize" id="firstname"> <?php echo $_SESSION['user'];?></label>
                                  </div>
                                  <div class="mb-1">
                                       ...
                                       <div class="col-md-12 order-md-2 mb-4">
                                              ...
                                              <div class="card p-2">
                                                ...
                                                <div class="form-white-box" style="display:none">
                                                     <form action="payment/pm_checkout.php" method="post">
                            ...
                            <label>Name</label>
                            <div class="form-inp">
                            <input type="text" name="firstname" value=" <?php echo $_SESSION['user'];?>" id = "input_name" placeholder="Nita Nisha"/>
                            </div>
                            </div>
