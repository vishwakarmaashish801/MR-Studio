...
$KEY = "gzemsh";
$salt="iZspKOPu"; //Please change the value with the live salt for production environment  salt  OEyWyUkn
...
echo $posted_hash;
       ...
       if ($reverse_hash != $posted_hash) {
	       echo "Transaction has been tampered. Please try again";
	         header("location:https://easinessbiz.com/police/pm_success-payment");
		   }
...
<p>"productinfo": <?php $productinfo ?>,</p>
