  ...
  <body>
    ...
    <div class="container form-container" style="margin-top:40px;margin-bottom:40px;">
      ...
      <div class="form-title">
        <h5 class="text-center" style="color:#2170AC;">Police Professional</h5>
       ...
       <div class=" col-md-4 p-2">
        ...
        <div class="row form-container">
          <div class="col-md-12 text-center  form-check form-container">
              <p class="mt-0 ms-0" style="color:#2170AC;">Already have an account ? <a href="/police/" >Login</a></p>
