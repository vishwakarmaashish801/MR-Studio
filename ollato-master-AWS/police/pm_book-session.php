                            ...
                            <div class="col-lg-12">
                             <div class="card shadow mb-4">
                                 <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Book Session </h6>
                                    </div>
                                     ...
                                     <div class="row mt-3 mb-3 p-2">
                                        ...
                                        <div class="card-body">
                                         <h3 class="card-title text-primary" style="color:solid rebeccapurple;font-weight:800">Book Session Empty!!</h3>
                                         <p class="card-text">You don’t have any book session.</p>
                                         </div></div>
                                        </div>
