...
if(!isset($_SESSION['loggedin'])){ //if login in session is not set   ASHRAM FILE
...
if($payment_status == 'Active'){
            ...
            $query = "SELECT * FROM questions_ashram ORDER BY sr_no ASC LIMIT $start_from, $record_per_page";  
            ...
            //  end table body
             ...
             $page_query = "SELECT * FROM questions_ashram ORDER BY sr_no ASC";  
            ...
            $output .='</div> </div>'; 
             echo $output;  
              ...
              $payment_fail  .='<div class="col-md-6 mx-auto">
                                ...
                                //  <a href="/ashram/package.php" class="btn btn-primary">Back to Package OR Payment Mode</a> 
                                 </div></div>';
               echo $payment_fail;
           }
